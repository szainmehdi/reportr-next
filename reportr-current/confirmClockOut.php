...
//get GET variables
if(isset($_GET['error'])) {
	$msg = "An error occured. You were not clocked out.<br />\n<span class='sub'>Try again or ask for help.</span>";
}
else if(isset($_GET['name'])) {
	$name = $_GET['name'];
	$hours = $_GET['hours'];
	$msg = "<span class='name'>$name</span>, you were successfully clocked out. <br />\n<span class='sub'><strong>Time worked:</strong> $hours hrs</span>";	
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    	<?php require 'includes/ReportrHTML_wrappersTop.inc.php'; ?>
          <div class="editableContent clockOutConfirmPage">
